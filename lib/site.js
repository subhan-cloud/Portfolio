export const site = {
  ...
  email: "subhanshehzada80@gmail.com",
  ...
  skills: {
    Frontend: ["HTML5", "CSS3", "React", "Next.js", "JavaScript (ES6+)", "TypeScript", "Tailwind CSS", "Framer Motion", "React Three Fiber"],
    Backend: ["Node.js", "REST APIs", "Server Actions", "Auth (Clerk)", "Cloudinary", "Authentication & Authorization"],
    Database: ["MongoDB", "Mongoose", "Database Design", "CRUD Operations"],
    Tools: ["Git & GitHub", "Vercel", "Figma", "Cursor", "Postman"],
  },
};
