export const site = {
  ...
  social: {
    ...
    linkedin: " https://www.linkedin.com/in/muhammad-subhan-418b7b429",
    upwork: "https://www.upwork.com/freelancers/~01447be41b38a844a2?mp_source=share",
    fiverr: "",
  },
  skills: {
    Frontend: ["React", "Next.js", "JavaScript (ES6+)", "TypeScript", "Tailwind CSS", "Framer Motion", "React Three Fiber"],
    Backend: ["Node.js", "REST APIs", "Server Actions", "Auth (Clerk)", "Express.js"],
    Database: ["MongoDB", "Mongoose"],
    Tools: ["Git & GitHub", "Vercel", "Figma", "Cursor", "Postman", "VS Code"],
  },
};
